...
//         _leftHandSynthWrapper.SetActive(false);
...
//         if (prefab == null)
//         {
//             if (log) Debug.LogWarning($"[TrackingDataVisualizer2] Prefab NULL for {prefix}. No markers created.", this);
//             return dict;
//         }
...
//             {
//                 // Keep your naming style, just different prefix
...
//         {
//             if (log) Debug.LogWarning("[TrackingDataVisualizer2] json is null/empty", this);
//             return;
//         }
...
//         {
//             Debug.LogWarning($"[TrackingDataVisualizer2] JSON parse error: {e.Message}", this);
//             return;
//         }
...
//             // Important: guard against null wrapper
