...
(() => {
  ...
  async function record(action) {
    ...
    setBusy(true); const payload={participant:$('participant').value,target_id:currentPart.file,description,presentation_number:presentation,target_presentations:Number($('target').value)||3,action};
